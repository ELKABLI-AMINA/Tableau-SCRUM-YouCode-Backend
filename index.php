...
<body>
	...
	<div id="app" class="app app-header-fixed app-sidebar-fixed">
		...
		<div id="content" class="app-content" style="min-height: 100vh; background: url(assets/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
			<div class="d-flex align-items-center mb-3">
				...
				<div class="ms-auto">
				<a href="#modal-task" data-bs-toggle="modal" class="btn btn-success btn-rounded px-4 rounded-pill" id="show_modal"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i> Add Task</a>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">To do (<span id="to_do_tasks_count"></span>)</h4>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">In Progress (<span id="in_progress_tasks_count"></span>)</h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-success" data-toggle="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i class="fa fa-minus"></i></a>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title">Done (<span id="done_tasks_count"></span>)</h4>
							<div class="panel-heading-btn">
								<a href="javascript:;" class="btn btn-xs btn-icon btn-default" data-toggle="panel-expand"><i class="fa fa-expand"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-success" data-toggle="panel-reload"><i class="fa fa-redo"></i></a>
								<a href="javascript:;" class="btn btn-xs btn-icon btn-warning" data-toggle="panel-collapse"><i class="fa fa-minus"></i></a>
	...
	<!-- TASK MODAL -->
	<button href="#modal-task" data-bs-toggle="modal" id="showed"></button>
				...
				<form action="scripts.php" method="POST" id="form-task">
					...
					<div class="modal-body">
							...
							<div class="mb-3">
								...
								<input type="text" name="title" class="form-control" id="title_task"/>
							...
							<div class="mb-3">
								...
								<div class="ms-3">
									<div class="form-check mb-1">
										<input class="form-check-input" name="task_type" type="radio" value="Feature" id="task_type_feature"/>
							...
							<div class="mb-0">
								...
								<textarea class="form-control" rows="10" id="task_description" name="description"></textarea>
							</div>
    ...
    let title = document.getElementById(id+"ts");
    let type = document.getElementById(id+"ty");
    let priority = document.getElementById(id+"p");
    let status = document.getElementById(id+"s");
    let description = document.getElementById(id+"di");
    let date = document.getElementById(id+"d");
    task_id.value =id;
    title_task.value = title.getAttribute("value");
    task_date.value = date.getAttribute("data");
	task_status.value = status.getAttribute("data");
    task_description.value = description.getAttribute("data");
